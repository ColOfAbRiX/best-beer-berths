...
// Global status
var beerDb, centerHome = true, currentPosition;
 ...
 */
function setHome( homePosition, init = false, center = true ) {
  if ( init ) {
    // Add home marker
